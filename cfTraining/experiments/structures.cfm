...
<body>
	...
	<cfset stUser.firstName='Subash'/>
	<cfset stUser.lastName='Khatri'/>
	<cfset stUser.age=23 />
	...
	<cfset stUserImplicit = {firstName='subash', lastName='khatri', age=23} />
	
	<p>Dumping the implicit structure</p>
	<cfdump var="#stUserImplicit#" label="Implicit Strucutre" >
	...
	<cfdump var="#stUser#" label="Explicit Structure deletion" >
	
	<!---Step 4 - use structClear() --->
	<cfset structClear(stUser)/>
	
	<p>Dumping stUser after using structClear()</p>
	<cfdump var="#stUser#" label="Explicit Structure clear" >
	
	<!---Step 5 - use structCount()--->
	
	<p>stUserImplicit holds <cfoutput >#structCount(stUserImplicit)#
